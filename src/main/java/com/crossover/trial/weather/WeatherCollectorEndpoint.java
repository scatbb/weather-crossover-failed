...
/**
 * 
 * THIS INTERFACE WAS RENAMED AND REDESIGNED (WITHOUT LOOSE OF CONTRACT AND OUTPUT)
 * AND LEAVED HERE ONLY FOR DoNotChangeTest CLASS
 * 
 * THIS IS USELESS FOR REDESIGNED PROJECT
 *  
